  ...
  .graph_specs <- list(
    list(
      ...
      render = function() {
        ...
        render_graph(.hh_ger_export_monthly(caption = "Datenquelle: Statistisches Bundesamt",
        ...
        render_graph(.hh_ger_export_monhtly(caption = "Federal statistical office (Destatis)",
